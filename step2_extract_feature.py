...
"""Đọc ảnh, chuyển hệ màu, resize ảnh"""
def read_image(image_path):
    ...
    return img_rgb
"""Kết quả của bước đọc ảnh: cao, rộng, số kênh màu"""


"""Trích chọn đặc trưng màu cơ bản"""
...
"""Trích chọn đặc trưng độ xanh + tỉ lệ màu RGB """
...
"""Trích chọn đặc trưgn kết cấu bề mặt lá: GLCM + LBP """
